...
wk.add({g({"s", "Search"}), c({"sb", "Telescope buffers", "Find Buffer"}), c({"sf", "Telescope find_files", "Find File"}), c({"sn", "enew", "New File"}), c({"sr", "Telescope oldfiles", "Open Recent File"}), c({"st", "Telescope live_grep", "Find Text"})})
